...
class StockCalculatorCase2Test: FhirParseable() {
    ...
    fun testIfFlagsThatIntersectWithMeasurementPeriodJan() {
        ...
        assertEquals(4, params.getParameters("Flags that Intersect with Measurement Period").size)
    }
    ...
    fun testDaysOutOfStockJan() {
        ...
        assertEquals(31, (params.getParameter("Days Out Of Stock") as IntegerType).value)
    }
    ...
    fun testIfFlagsThatIntersectWithMeasurementPeriodDec() {
        ...
        assertEquals(2, params.getParameters("Flags that Intersect with Measurement Period").size)
    }
    ...
    fun testDaysOutOfStockDec() {
        ...
        assertEquals(13, (params.getParameter("Days Out Of Stock") as IntegerType).value)
    }
}